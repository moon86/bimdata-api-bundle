 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\RawElementsRequest
 */
class RawElementsRequestTest extends TestCase
{
    protected RawElementsRequest|MockObject $object;
    ...
    {
         $this->object = $this->getMockBuilder(RawElementsRequest::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(RawElementsRequest::class));
        $this->assertInstanceOf(RawElementsRequest::class, $this->object);
    }
