 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\FullTopic
 */
class FullTopicTest extends TestCase
{
    protected FullTopic|MockObject $object;
    ...
    {
         $this->object = $this->getMockBuilder(FullTopic::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(FullTopic::class));
        $this->assertInstanceOf(FullTopic::class, $this->object);
    }
     ...
     * @small
     */
    public function testPropertyModifiedDate(): void
    {
        $this->markTestSkipped('Test for property modifiedDate not implemented');
    }
     ...
     * @small
     */
    public function testPropertyViewpoints(): void
    {
        $this->markTestSkipped('Test for property viewpoints not implemented');
    }
