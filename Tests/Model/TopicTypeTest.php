 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\TopicType
 */
class TopicTypeTest extends TestCase
{
    protected TopicType|MockObject $object;
    ...
    {
         $this->object = $this->getMockBuilder(TopicType::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(TopicType::class));
        $this->assertInstanceOf(TopicType::class, $this->object);
    }
