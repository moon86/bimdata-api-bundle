 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\PatchedFullTopicRequest
 */
class PatchedFullTopicRequestTest extends TestCase
{
    protected PatchedFullTopicRequest|MockObject $object;
    ...
    {
         $this->object = $this->getMockBuilder(PatchedFullTopicRequest::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(PatchedFullTopicRequest::class));
        $this->assertInstanceOf(PatchedFullTopicRequest::class, $this->object);
    }
