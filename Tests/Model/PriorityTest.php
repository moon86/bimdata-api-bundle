 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\Priority
 */
class PriorityTest extends TestCase
{
    protected Priority|MockObject $object;
    ...
    {
         $this->object = $this->getMockBuilder(Priority::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(Priority::class));
        $this->assertInstanceOf(Priority::class, $this->object);
    }
