 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\ElementRequest
 */
class ElementRequestTest extends TestCase
{
    protected ElementRequest|MockObject $object;
    ...
    {
         $this->object = $this->getMockBuilder(ElementRequest::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(ElementRequest::class));
        $this->assertInstanceOf(ElementRequest::class, $this->object);
    }
