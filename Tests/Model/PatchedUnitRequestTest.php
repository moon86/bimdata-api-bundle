 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\PatchedUnitRequest
 */
class PatchedUnitRequestTest extends TestCase
{
    protected PatchedUnitRequest|MockObject $object;
    ...
    {
         $this->object = $this->getMockBuilder(PatchedUnitRequest::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(PatchedUnitRequest::class));
        $this->assertInstanceOf(PatchedUnitRequest::class, $this->object);
    }
