 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\UserProject
 */
class UserProjectTest extends TestCase
{
    protected UserProject|MockObject $object;
    ...
    {
         $this->object = $this->getMockBuilder(UserProject::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(UserProject::class));
        $this->assertInstanceOf(UserProject::class, $this->object);
    }
