 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\ZoneRequest
 */
class ZoneRequestTest extends TestCase
{
    protected ZoneRequest|MockObject $object;
    ...
    {
         $this->object = $this->getMockBuilder(ZoneRequest::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(ZoneRequest::class));
        $this->assertInstanceOf(ZoneRequest::class, $this->object);
    }
