 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\PropertyDefinitionUnit
 */
class PropertyDefinitionUnitTest extends TestCase
{
    protected PropertyDefinitionUnit|MockObject $object;
    ...
    {
         $this->object = $this->getMockBuilder(PropertyDefinitionUnit::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(PropertyDefinitionUnit::class));
        $this->assertInstanceOf(PropertyDefinitionUnit::class, $this->object);
    }
