 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\ProjectRequest
 */
class ProjectRequestTest extends TestCase
{
    protected ProjectRequest|MockObject $object;
    ...
    {
         $this->object = $this->getMockBuilder(ProjectRequest::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(ProjectRequest::class));
        $this->assertInstanceOf(ProjectRequest::class, $this->object);
    }
