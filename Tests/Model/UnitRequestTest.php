 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\UnitRequest
 */
class UnitRequestTest extends TestCase
{
    protected UnitRequest|MockObject $object;
    ...
    {
         $this->object = $this->getMockBuilder(UnitRequest::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(UnitRequest::class));
        $this->assertInstanceOf(UnitRequest::class, $this->object);
    }
