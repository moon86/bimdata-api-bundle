 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\Unit
 */
class UnitTest extends TestCase
{
    protected Unit|MockObject $object;
    ...
    {
         $this->object = $this->getMockBuilder(Unit::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(Unit::class));
        $this->assertInstanceOf(Unit::class, $this->object);
    }
