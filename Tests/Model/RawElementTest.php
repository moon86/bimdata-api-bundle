 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\RawElement
 */
class RawElementTest extends TestCase
{
    protected RawElement|MockObject $object;
    ...
    {
         $this->object = $this->getMockBuilder(RawElement::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(RawElement::class));
        $this->assertInstanceOf(RawElement::class, $this->object);
    }
