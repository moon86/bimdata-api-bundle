 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\FullTopicRequest
 */
class FullTopicRequestTest extends TestCase
{
    protected FullTopicRequest|MockObject $object;
    ...
    {
         $this->object = $this->getMockBuilder(FullTopicRequest::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(FullTopicRequest::class));
        $this->assertInstanceOf(FullTopicRequest::class, $this->object);
    }
