 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\RawUnit
 */
class RawUnitTest extends TestCase
{
    protected RawUnit|MockObject $object;
    ...
    {
         $this->object = $this->getMockBuilder(RawUnit::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(RawUnit::class));
        $this->assertInstanceOf(RawUnit::class, $this->object);
    }
