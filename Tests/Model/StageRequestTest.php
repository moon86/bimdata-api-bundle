 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\StageRequest
 */
class StageRequestTest extends TestCase
{
    protected StageRequest|MockObject $object;
    ...
    {
         $this->object = $this->getMockBuilder(StageRequest::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(StageRequest::class));
        $this->assertInstanceOf(StageRequest::class, $this->object);
    }
