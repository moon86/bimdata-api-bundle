 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\ProjectInvitation
 */
class ProjectInvitationTest extends TestCase
{
    protected ProjectInvitation|MockObject $object;
    ...
    {
         $this->object = $this->getMockBuilder(ProjectInvitation::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(ProjectInvitation::class));
        $this->assertInstanceOf(ProjectInvitation::class, $this->object);
    }
