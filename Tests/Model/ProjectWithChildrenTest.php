 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\ProjectWithChildren
 */
class ProjectWithChildrenTest extends TestCase
{
    protected ProjectWithChildren|MockObject $object;
    ...
    {
         $this->object = $this->getMockBuilder(ProjectWithChildren::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(ProjectWithChildren::class));
        $this->assertInstanceOf(ProjectWithChildren::class, $this->object);
    }
    ...
    /**
     * Test attribute "rootFolderId"
     *
     * @group unit
     * @small
     */
    public function testPropertyRootFolderId(): void
    {
        $this->markTestSkipped('Test for property rootFolderId not implemented');
    }
}
