 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\PointRequest
 */
class PointRequestTest extends TestCase
{
    protected PointRequest|MockObject $object;
    ...
    {
         $this->object = $this->getMockBuilder(PointRequest::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(PointRequest::class));
        $this->assertInstanceOf(PointRequest::class, $this->object);
    }
