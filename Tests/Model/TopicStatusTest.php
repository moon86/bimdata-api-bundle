 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\TopicStatus
 */
class TopicStatusTest extends TestCase
{
    protected TopicStatus|MockObject $object;
    ...
    {
         $this->object = $this->getMockBuilder(TopicStatus::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(TopicStatus::class));
        $this->assertInstanceOf(TopicStatus::class, $this->object);
    }
