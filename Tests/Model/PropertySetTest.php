 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\PropertySet
 */
class PropertySetTest extends TestCase
{
    protected PropertySet|MockObject $object;
    ...
    {
         $this->object = $this->getMockBuilder(PropertySet::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(PropertySet::class));
        $this->assertInstanceOf(PropertySet::class, $this->object);
    }
