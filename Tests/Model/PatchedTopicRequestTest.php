 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\PatchedTopicRequest
 */
class PatchedTopicRequestTest extends TestCase
{
    protected PatchedTopicRequest|MockObject $object;
    ...
    {
         $this->object = $this->getMockBuilder(PatchedTopicRequest::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(PatchedTopicRequest::class));
        $this->assertInstanceOf(PatchedTopicRequest::class, $this->object);
    }
