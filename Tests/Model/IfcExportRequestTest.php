 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\IfcExportRequest
 */
class IfcExportRequestTest extends TestCase
{
    protected IfcExportRequest|MockObject $object;
    ...
    {
         $this->object = $this->getMockBuilder(IfcExportRequest::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(IfcExportRequest::class));
        $this->assertInstanceOf(IfcExportRequest::class, $this->object);
    }
