 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\Snapshot
 */
class SnapshotTest extends TestCase
{
    protected Snapshot|MockObject $object;
    ...
    {
         $this->object = $this->getMockBuilder(Snapshot::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(Snapshot::class));
        $this->assertInstanceOf(Snapshot::class, $this->object);
    }
