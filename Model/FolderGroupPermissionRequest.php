...
/**
 * Class representing the FolderGroupPermissionRequest model.
 *
 * @package OpenAPI\Server\Model
 * @author  OpenAPI Generator team
 */
class FolderGroupPermissionRequest 
{
     ...
     * @Assert\NotNull()
     * @Assert\Valid()
     * @Assert\Type("OpenAPI\Server\Model\GroupRequest")
     * @Type("OpenAPI\Server\Model\GroupRequest")
     */
    protected ?GroupRequest $group = null;
     ...
     */
    public function getGroup(): ?GroupRequest
    {
        return $this->group;
    }
     ...
     * Sets group.
     *
     * @param GroupRequest|null $group
     *
     * @return $this
     */
    public function setGroup(?GroupRequest $group): self
    {
        $this->group = $group;
