...
/**
 * Class representing the Rule model.
 *
...
class Rule 
{
     ...
     * @Assert\All({
     *   @Assert\Type("OpenAPI\Server\Model\RuleComponent")
     * })
     * @Type("array<OpenAPI\Server\Model\RuleComponent>")
     */
     ...
     * @Type("OpenAPI\Server\Model\Rule")
     */
    protected ?Rule $on = null;
     ...
     * @return $this
     */
    public function setOn(?Rule $on = null): self
    {
        $this->on = $on;
