...
/**
 * Class representing the PatchedElementRequest model.
 *
...
class PatchedElementRequest 
{
    ...
    /**
     * @var PropertySetRequest|null
     * @SerializedName("attributes")
     * @Assert\Type("OpenAPI\Server\Model\PropertySetRequest")
     * @Type("OpenAPI\Server\Model\PropertySetRequest")
     */
    protected ?PropertySetRequest $attributes = null;
     ...
     * @Assert\All({
     *   @Assert\Type("OpenAPI\Server\Model\ClassificationRequest")
     * })
     * @Type("array<OpenAPI\Server\Model\ClassificationRequest>")
     */
     ...
     * @Assert\All({
     *   @Assert\Type("OpenAPI\Server\Model\LayerElementRequest")
     * })
     * @Type("array<OpenAPI\Server\Model\LayerElementRequest>")
     */
     ...
     * Gets attributes.
     *
     * @return PropertySetRequest|null
     */
    public function getAttributes(): ?PropertySetRequest
    {
     ...
     * Sets attributes.
     *
     * @param PropertySetRequest|null $attributes
     *
     * @return $this
     */
    public function setAttributes(?PropertySetRequest $attributes = null): self
    {
