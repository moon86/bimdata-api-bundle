...
/**
 * Class representing the FullTopic model.
 *
 * @package OpenAPI\Server\Model
 * @author  OpenAPI Generator team
 */
class FullTopic 
{
     ...
     * @Assert\All({
     *   @Assert\Type("OpenAPI\Server\Model\Comment")
     * })
     * @Type("array<OpenAPI\Server\Model\Comment>")
     */
     ...
     * @Assert\All({
     *   @Assert\Type("OpenAPI\Server\Model\Viewpoint")
     * })
     * @Type("array<OpenAPI\Server\Model\Viewpoint>")
     */
