...
/**
 * Class representing the PatchedPropertyDefinitionRequestUnit model.
 *
 * @package OpenAPI\Server\Model
 * @author  OpenAPI Generator team
 */
class PatchedPropertyDefinitionRequestUnit 
{
        /**
     ...
     * @Assert\Type("OpenAPI\Server\Model\UnitRequest")
     * @Type("OpenAPI\Server\Model\UnitRequest")
     */
    protected ?UnitRequest $conversionBaseunit = null;
     ...
     */
    public function getConversionBaseunit(): ?UnitRequest
    {
     ...
     *
     * @param UnitRequest|null $conversionBaseunit
     *
     * @return $this
     */
    public function setConversionBaseunit(?UnitRequest $conversionBaseunit = null): self
    {
